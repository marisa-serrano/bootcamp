...
public class SimpleGfxGridTest {
    ...
    private static TestResult stepOne(SimpleGfxGrid grid) {
        ...
        if (grid.getWidth() != COL_NUM * grid.getCellSize() || grid.getHeight() != ROW_NUM * grid.getCellSize()) {
            ...
            System.out.println("grid weed " + grid.getWidth()) ;
            System.out.println(COL_NUM + "colnum");


            System.out.println("grid weed " + grid.getHeight()) ;
            System.out.println(ROW_NUM + "colnum");
            System.out.println("badadadada" + grid.getCellSize());
    ...
    private static TestResult stepThree(SimpleGfxGrid grid) {
        ...
        try {
            ...
            System.out.println("x: " + gridPos.getX() + ", y: " + gridPos.getY() + ", padding: " + SimpleGfxGrid.PADDING);
